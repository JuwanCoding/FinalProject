...
<div class="section" style="border-right-style: groove;">
...
<%-- 
					...
					<button class="move btn btn-primary" data-sitter="${request.sitter }">매니저정보</button>
					<button class="reviewMove btn btn-primary" data-payment="${request.payment }" data-rbno="${request.rbno }" data-sitter="${request.sitter }"  data-requester="${request.writer }" >완료</button>
		...
		<div class="card mb-3">
			<div class="row g-0 card-info" >
					...
					<div class="col-md-6">
						...
						<button class="move btn btn-primary" data-sitter="${reply.sitter }">매니저정보</button>
					<button class="reviewMove btn btn-primary" data-payment="${reply.payment }" data-rsbno="${reply.rsbno }" data-sitter="${reply.sitter }"  data-requester="${reply.replyer }" >완료</button>
