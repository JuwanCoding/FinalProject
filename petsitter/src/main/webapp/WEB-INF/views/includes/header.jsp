...
<div class="header-body">
	<header
		...
		<ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
			<li id="head-request"><a href="/request/list"
				class="nav-link px-2 link-dark head-link" id="request">돌봄요청하기</a></li>
			<li id="head-sitrequest"><a href="/sitrequest/list"
				class="nav-link px-2 link-dark head-link">돌봄매니저소개</a></li>
			<li id="head-matching"><a href="/matching/requester"
				class="nav-link px-2 link-dark head-link">요청자매칭정보</a></li>
			<li id="head-request"><a href="/matching/sitter"
				class="nav-link px-2 link-dark head-link">매니저매칭정보</a></li>
			<li id="head-request"><a href="/answer/list"
				class="nav-link px-2 link-dark head-link">자주묻는질문</a></li>
		</ul>
	</header>
</div>
<script>
